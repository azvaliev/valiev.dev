...
function Testimonials(): JSX.Element {
  return (
    <section className="flex flex-col w-full py-12 bg-gray-100">
      ...
      <div className="grid mx-auto w-[95%] sm:w-[85%] md:w-full grid-cols-1 grid-rows-3 md:grid-cols-3 md:grid-rows-1 flex-col lg:flex-row justify-between">
        {testimonialData.map((testimonial) => (
          <div key={testimonial.title} className="flex flex-col border-b-[1px] w-[95%] mx-auto pb-4 mb-8 md:pb-2 md:mb-2 border-gray-300 w-full px-4 text-center">
