...
function Navbar(): JSX.Element {
  return (
    <nav className="flex w-full h-[10vh] bg-[hsla(0,0%,100%,.88)] items-center justify-end gap-4 md:gap-8 px-4 z-20 sticky top-0">
      {navitems.map((item) => (
      ...
      >
        <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" fill="black">
