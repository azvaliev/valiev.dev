...
function Portfolio(): JSX.Element {
  return (
    <>
      ...
      <h1 className="text-5xl text-center font-medium font-everett-regular">
        Portfolio
      </h1>
      <main>
        {portfolioData.map((portfolioItem, idx) => (
          <div
            ...
            className={
              `flex items-center justify-around mt-14 rounded-sm
               ${idx % 2 ? 'flex-row-reverse' : 'flex-row'}`
             }
          >
            <div className="flex flex-col items-center w-[40%] text-center py-2 px-4 shadow-xl">
              ...
              <div className="flex flex-row flex-wrap gap-2 mb-4 max-w-[90%] mx-auto justify-between">
